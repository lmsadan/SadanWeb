      ...
      <div class="wrapper">
        <div class="person-baseinfo">
          ...
          <div class="info">
            ...
            <ul class="fill">
              <li>
                <i class="fa fa-map-marker" aria-hidden="true" /> <span class="edit-item"> 填写现居城市</span>
              ...
              <li>
                <i class="fa fa-graduation-cap" aria-hidden="true" /> <span class="edit-item"> 填写毕业院校</span>
                <form action="" class="sui-form form-inline">
              ...
              <li>
                <i class="fa fa-shopping-bag" aria-hidden="true" /> <span class="edit-item"> 填写所在公司/组织</span>
                <form action="" class="sui-form form-inline">
              ...
              <li>
                <i class="fa fa-link" aria-hidden="true" /> <span class="edit-item"> 填写个人网站</span>
                <form action="" class="sui-form form-inline">
    ...
    <div class="wrapper  myhome">
      <div class="left-list">
        <div class="myhome-list">
          <ul class="home-list">
            <nuxt-link to="/home" tag="li" active-class="active" exact>
              <a>我的主页</a>
            </nuxt-link>
            <nuxt-link to="/home/myanswer" tag="li" active-class="active">
              <a>我的回答</a>
            </nuxt-link>
            <nuxt-link to="/home/myquestion" tag="li" active-class="active">
              <a>我的提问</a>
            </nuxt-link>
            <nuxt-link to="/home/myshare" tag="li" active-class="active">
              <a>我的分享</a>
            </nuxt-link>
          </ul>
          <ul class="home-list bottom">
            <nuxt-link to="/home/dynamic" tag="li" active-class="active">
              <a>个人动态</a>
            </nuxt-link>
            <nuxt-link to="/home/myfocus" tag="li" active-class="active">
              <a>我的关注</a>
            </nuxt-link>
            <nuxt-link to="/home/mycollect" tag="li" active-class="active">
              <a>我的收藏</a>
            </nuxt-link>
            <nuxt-link to="/home/myreaded" tag="li" active-class="active">
              <a>浏览记录</a>
            </nuxt-link>
            <nuxt-link to="/home/account" tag="li" active-class="active">
              <a>账户设置</a>
            </nuxt-link>
          </ul>
        </div>
