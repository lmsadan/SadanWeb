                    ...
                    <ul class="detail-list">
                      <li class="qa-item">
                        ...
                        <div class="fl info">
                          <div class="question">
                            <p class="author">
                              <span class="name">luckness</span><span>3</span>分钟前回答
                            </p>
                            <p class="title">
                              <a href="~/assets/qa-detail.html" target="_blank">有关PHP初级进阶的问题？</a>
                            </p>
                          </div>
                          <div class="other">
                            <ul class="fl sui-tag">
                      ...
                      <li class="qa-item">
                        ...
                        <div class="fl info">
                          <div class="question">
                            <p class="author">
                              <span class="name">牛奶糖</span><span>3</span>分钟前回答
                            </p>
                            <p class="title">
                              <a href="~/assets/qa-detail.html" target="_blank">springMVC的controller接收json数据失败</a>
                            </p>
                          </div>
                          <div class="other">
                            <ul class="fl sui-tag">
                      ...
                      <li class="qa-item">
                        ...
                        <div class="fl info">
                          <div class="question">
                            <p class="author">
                              <span class="name">大白兔</span><span>3</span>分钟前回答
                            </p>
                            <p class="title">
                              <a href="~/assets/qa-detail.html" target="_blank">监听器中timer查询数据库</a>
                            </p>
                          </div>
                          <div class="other">
                            <ul class="fl sui-tag">
                      ...
                      <li class="qa-item">
                        ...
                        <div class="fl info">
                          <div class="question">
                            ...
                            <p class="title">
                              <a href="~/assets/qa-detail.html" target="_blank">服务器上安装了一个考试系统ASP.NET,安装完成后访问不了，求助</a>
                            </p>
                          </div>
                          <div class="other">
                            <ul class="fl sui-tag">
